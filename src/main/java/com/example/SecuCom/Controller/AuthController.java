...
import com.example.SecuCom.Payload.LoginDto;
import com.example.SecuCom.Payload.SignUpDto;
...
public class AuthController {
    ...
    public ResponseEntity<?> registerUser(@RequestBody SignUpDto signUpDto){
        ...
        collaborateurs.setPrenom(signUpDto.getPrenom());
        ...
        Role roles = roleRepository.findByNom("USER").get();
